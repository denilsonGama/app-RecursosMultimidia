...
class Rotas_e_Pontos_de_Interesse_Ponto1 : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_ponto1)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val ponto_de_interesse_latitude_longitude = LatLng(-23.5440055,-46.629888)
