 ...
 */
class Rotas_e_Pontos_de_Interesse_Rota3 : FragmentActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_rota3)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val pontoA = fiap_campus_vila_mariana;
        val pontoB = fiap_campus_paulista;

        val unidadePontoA = unidades[2]
        val unidadePontoB = unidades[1]
