...
class Rotas_e_Pontos_de_Interesse_Ponto5 : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_ponto5)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val ponto_de_interesse_informacoes =
                arrayOf("Parque CienTec",
                        "Vila Agua Funda\nAv. Pedro Álvares Cabral, s/n\nSão Paulo - SP")

        //--Coordenadas do Ponto de Interesse
        val ponto_de_interesse_latitude_longitude = LatLng(-23.6492958,-46.625292)
