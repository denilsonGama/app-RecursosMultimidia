...
class Rotas_e_Pontos_de_Interesse_Ponto3 : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_ponto3)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val ponto_de_interesse_informacoes =
                arrayOf("Museu de Microbiologia",
                        "Butantan\nAv. Vital Brasil, 1500\nSão Paulo - SP")

        //--Coordenadas do Ponto de Interesse
        val ponto_de_interesse_latitude_longitude = LatLng(-23.5663329,-46.7208174)
