 ...
 */
class Rotas_e_Pontos_de_Interesse_Rota2 : FragmentActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_rota2)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val pontoA = fiap_campus_vila_olimpia;
        val pontoB = fiap_campus_vila_mariana;

        val unidadePontoA = unidades[0]
        val unidadePontoB = unidades[2]
