...
class Rotas_e_Pontos_de_Interesse_Ponto2 : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rotas_e_pontos_de_interesse_ponto2)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val ponto_de_interesse_informacoes =
                arrayOf("Sabina Escola\nParque do Conhecimento",
                        "Parque Dom Pedro II\nRua Juquiá, s/n\nSanto André - SP")

        //--Coordenadas do Ponto de Interesse
        val ponto_de_interesse_latitude_longitude = LatLng(-23.6791019,-46.53342)
